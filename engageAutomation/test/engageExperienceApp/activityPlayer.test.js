...
module.exports = {
	...
	ENG_PLAY_TC_1: function (testdata) {
		...
		if (sts.quesNumber == null) {
			...
			assertion.assertEqual(sts.prevActivityBtn.trim(), testdata.prevActivityBtn[0], "prevActivityBtn status mismatch");
			if (sts.closeBtn == null)
				assertion.assertEqual(sts.nextActivityBtn.trim(), testdata.nextActivityBtn[0], "nextActivityBtn status mismatch");
			else
