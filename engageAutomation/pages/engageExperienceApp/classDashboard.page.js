...
module.exports = {
	...
	click_ClassCard: function (className) {
		//console.log("**classname testdata passed -",className)
		logger.logInto(stackTrace.get());
	...
	getClassIndex: function (className) {
		...
		//console.log("find elements classname -",res.length)
		if (res.length == 0) {
			...
			for (var i = 0; i < res.length; i++) {
				...
				// console.log("Find class name - ",findClassName)
				// console.log("className ==>", "hello" + className + "hi");
				//-----MACOS-----
